...
- This repository uses the conda environment `main` for Python work.
- Prefer `conda run -n main python ...` instead of calling `python` directly.
- Run installs, tests, scripts, and one-off verification commands in `main`.
